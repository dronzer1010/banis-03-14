angular.module('starter').controller('SegmentostaffaddController', function($scope,
 $state, $window, $location, $anchorScroll, $timeout, $cordovaFileTransfer, $ionicLoading, $ionicPopup) {
